...
<body>
	<div class="container">
		...
		<h3 class="marginTop marginBottom" onclick="location.href='<%=boardListURL%>'">게시판📢</h3>
		
		<div>
			<form method="post" action="<%=request.getContextPath() %>/board/updateBoard.do" class="form-horizontal cursorPoint">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 ">
						<input type="text" id="boardWriter" class="form-control form-inline" readonly="readonly" value="<%=boardVO.getBoardWriter() %>">
					</div>
				</div>
				<div class="form-group">
					<label for="boardTitle" class="col-sm-2 control-label">제목</label>
					<div class="col-sm-8 ">
						<input type="text" name="boardTitle" id="boardTitle" class="form-control form-inline" value="<%=boardVO.getBoardTitle() %>">
					</div>
				</div>
				<div class="form-group">
					<label for="boardContent" class="col-sm-2 control-label">내용</label>
					<div class="col-sm-8 ">
						<textarea name="boardContent" id="boardContent" class="form-control form-inline" style="height: 200px;"><%=boardVO.getBoardContent() %></textarea>
					</div>
				</div>
